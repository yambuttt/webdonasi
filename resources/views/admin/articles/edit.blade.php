...
@section('title', 'Edit Artikel - Pedulia')
@section('header-title', 'Edit Artikel')
@section('header-subtitle', 'Perbarui data artikel edukasi Anda')
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white border border-slate-100 p-6 rounded-2xl shadow-sm space-y-4">
                    ...
                    <div id="thumbnail-preview-box" class="h-44 w-full bg-slate-50 border border-slate-200 rounded-xl flex flex-col items-center justify-center text-slate-400 relative overflow-hidden group cursor-pointer">
                        <!-- Dynamic Preview Image (Initialised with existing thumbnail if present) -->
                        <img id="thumbnail-preview-img" src="{{ $article->thumbnail }}" class="absolute inset-0 w-full h-full object-cover {{ $article->thumbnail ? '' : 'hidden' }}">
                        
                        <!-- Icon placeholder -->
                        <div id="preview-placeholder" class="flex flex-col items-center justify-center {{ $article->thumbnail ? 'hidden' : '' }}">
