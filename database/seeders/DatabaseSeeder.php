...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        \App\Models\Setting::set('bank_account_name', 'Yayasan Pedulia');
        \App\Models\Setting::set('whatsapp_number', '6281234567890');

        // Seed default welcome pop-up configurations
        \App\Models\Setting::set('popup_active', '0');
        \App\Models\Setting::set('popup_type', 'custom_image');
        \App\Models\Setting::set('popup_custom_image', '/images/hero.png');
        \App\Models\Setting::set('popup_title', 'Selamat Datang di Pedulia!');
        \App\Models\Setting::set('popup_description', 'Platform donasi modern dan transparan.');
    }
}
